...
const services = [
    ...
    },
    {
      ...
      image: '/serv/Hardware Procurement and Installation.png',
      color: 'bg-sky-300',
    },
    {
      ...
      image: '/serv/Internet Service Provider.png',
      color: 'bg-sky-200',
    },
    {
      title: 'IT Consulting',
    ...
    },
    {
      ...
      image: '/serv/Network Infrastructure.png',
      color: 'bg-sky-100',
    },
    {
      title: 'Data Analytics',
      description: 'Our seasoned IT consultants offer strategic guidance to help you navigate complex technology landscapes. We provide expert advice on digital transformation, technology strategy, and IT infrastructure optimization.',
      image: '/serv/Data Analyt.png',
      color: 'bg-sky-200',
    },
    {
      ...
      image: '/serv/Security Service.png',
      color: 'bg-sky-300',
    },
  ];
